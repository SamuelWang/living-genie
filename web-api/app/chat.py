...
def build_system_prompt() -> str:
    return (
        ...
        "languages, etc.).\n"
        "- Give a direct, specific answer to the user's actual question. Never respond by "
        "just repeating a retrieved excerpt verbatim — read it, then state the answer in "
        "your own words (e.g. if asked what time of day something happened, answer with "
        "the time of day, not the whole excerpt).\n"
